...
if upchck==version:
	...
	try:
		...
		print(green)
		os.system("cd $HOME && git clone https://github.com/DareDevil360/bullet")
		clear()
		...
		for i in range(99999999999):
			os.system("clear")
			a=input(cyan+"\n"*10+" [>] Please Exit Termux from Notification Bar. Then Again Open Bullet Tools By :\n\n "+yellow+"\t [1] Exit Termux\n\t [2] Open Termux"+"\n\t [3] cd $HOME/roc-x"+yellow+"\n\t [4] "+yellow+"python3 main.py\n\n")
...
while count<2:
	...
	header()
	notice=""
	print(cyan+"\n🔥Welcome Attack Panal🔥 : ")
	print(yellow+"\n  {1} Bombing Attack\n\n  \n\n  \n\n  \n\n  \n\n  \n\n  ["+str(about)+"] "+end)
	main_opt=str(input(blue+"\n[>] Select Your Attack : "+yellow))
